...
$queryMusees->bindValue(':ville', $ville);
$queryMusees->bindValue(':type', $typeMusee);
$queryMusees->bindValue(':offset', $offset, PDO::PARAM_INT);
$queryMusees->bindValue(':perPage', $perPage, PDO::PARAM_INT);
$queryMusees->execute();

$result = $queryMusees->fetchAll(PDO::FETCH_ASSOC);
...
$totalQuery->bindValue(':type', $typeMusee);
$totalQuery->execute();

$totalMusees = $totalQuery->fetchColumn();
$totalPages = ceil($totalMusees / $perPage);
